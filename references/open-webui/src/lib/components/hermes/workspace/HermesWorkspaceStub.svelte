...
<div class="flex h-full min-h-0 flex-col px-2 py-2">
	...
	{#if !canBrowseWorkspace && workspaceItems.length === 0 && workspaceBrowserEntries.length === 0 && !workspaceBrowseLoading && !workspaceBrowseError && workspaceBrowseLoaded}
		<div
			class="mx-2 flex flex-1 min-h-0 items-center justify-center rounded-xl border border-dashed border-gray-200/80 bg-gray-50/70 px-4 py-6 text-center dark:border-gray-800 dark:bg-gray-900/30"
		>
			<div>
		...
		<div class="flex flex-1 min-h-0 flex-col overflow-hidden">
			<div class="flex-1 min-h-0 overflow-y-auto px-2">
				{#if canBrowseWorkspace}
					<div class="pb-3">
						...
						{:else if workspaceBrowserEntries.length === 0}
							<div
								class="mt-2 rounded-xl border border-dashed border-gray-200/80 bg-gray-50/70 px-4 py-4 text-center text-xs text-gray-500 dark:border-gray-800 dark:bg-gray-900/30 dark:text-gray-400"
							>
									...
									<button
										class="w-full rounded-xl border px-3 py-2 text-left transition {isWorkspaceEntrySelected(
											...
											: isWorkspaceEntryRemembered(entry)
												? 'border-gray-200/80 bg-gray-50/60 dark:border-gray-800 dark:bg-gray-900/70'
												: 'border-gray-100/80 bg-white/80 hover:border-gray-200 hover:bg-gray-50 dark:border-gray-800/80 dark:bg-gray-900/50 dark:hover:border-gray-700 dark:hover:bg-gray-900'}"
									...
									>
										<div class="flex items-start gap-3">
											...
											<div class="min-w-0 flex-1">
												<div
													class="line-clamp-1 text-sm font-medium text-gray-800 dark:text-gray-100"
												>
													{entry.name}
												</div>
												<div
				...
				{#if generatedWorkspaceItems.length > 0}
					<div class="pb-3">
						<div
							class="px-1 text-[11px] font-medium uppercase tracking-[0.08em] text-gray-400 dark:text-gray-500"
						>
						...
						<div class="mt-2 flex flex-col gap-1.5">
							{#each generatedWorkspaceItems as item}
								<button
									class="w-full rounded-xl border border-gray-100/80 bg-white/80 px-3 py-2 text-left transition hover:border-gray-200 hover:bg-gray-50 dark:border-gray-800/80 dark:bg-gray-900/50 dark:hover:border-gray-700 dark:hover:bg-gray-900"
								...
								>
									<div class="flex items-start justify-between gap-3">
										...
										<div
											class="shrink-0 rounded-full bg-gray-50 px-2 py-0.5 text-[11px] text-gray-500 dark:bg-gray-950/70 dark:text-gray-400"
										>
											{$i18n.t('Generated')}
										</div>
									</div>
