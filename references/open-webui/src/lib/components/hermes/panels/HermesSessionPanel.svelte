...
<div class="flex h-full min-h-0 flex-col px-2 py-2">
	...
	>
		<div class="text-sm font-medium text-gray-800 dark:text-gray-100">{$i18n.t('Session')}</div>
		...
		<div class="mt-3 grid grid-cols-2 gap-2">
			...
			<div class="rounded-xl bg-gray-50 px-3 py-2 dark:bg-gray-950/70">
				...
				<div class="mt-1 text-sm font-medium text-gray-700 dark:text-gray-200">{userCount}</div>
			</div>
	...
	<div
		class="mt-2 flex min-h-0 flex-1 flex-col rounded-xl border border-gray-100/80 bg-white/80 dark:border-gray-800/80 dark:bg-gray-900/50"
	>
