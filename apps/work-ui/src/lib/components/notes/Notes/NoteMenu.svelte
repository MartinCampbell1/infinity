<script lang="ts">
	...
	export let onDownload: (type: 'txt' | 'md' | 'pdf') => void = () => {};
...
>
	...
	<div slot="content">
		<div
			class="{className} min-w-[180px] text-sm rounded-2xl px-1 py-1 border border-gray-100 dark:border-gray-800 z-50 bg-white dark:bg-gray-850 dark:text-white shadow-lg"
		>
			<DropdownSub>
				<button
					slot="trigger"
