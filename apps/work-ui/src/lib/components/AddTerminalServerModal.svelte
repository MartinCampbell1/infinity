<script lang="ts">
	...
	type TerminalConnectionAccessGrant = {
		id?: string;
	...
	export let connection: TerminalServerConnection | null = null;

	export let onSubmit: (connection: TerminalServerConnection) => void = () => {};
	...
	let accessGrants: TerminalConnectionAccessGrant[] = [];
	...
	const buildPolicyData = (): TerminalConnectionPolicy => {
		const data: TerminalConnectionPolicy = {};
	...
	const submitHandler = async () => {
		...
		const result: TerminalServerConnection = {
