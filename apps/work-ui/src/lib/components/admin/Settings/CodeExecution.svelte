<script lang="ts">
	...
	type CodeExecutionConfig = {
		...
		CODE_EXECUTION_ENGINE: 'pyodide' | 'jupyter' | string;
		CODE_EXECUTION_JUPYTER_URL: string;
		CODE_EXECUTION_JUPYTER_AUTH: 'token' | 'password' | '';
		CODE_EXECUTION_JUPYTER_AUTH_PASSWORD: string;
		CODE_EXECUTION_JUPYTER_AUTH_TOKEN: string;
		CODE_EXECUTION_JUPYTER_TIMEOUT: number | string;
		ENABLE_CODE_INTERPRETER: boolean;
		CODE_INTERPRETER_ENGINE: 'pyodide' | 'jupyter' | string;
		CODE_INTERPRETER_JUPYTER_URL: string;
		CODE_INTERPRETER_JUPYTER_AUTH: 'token' | 'password' | '';
		CODE_INTERPRETER_JUPYTER_AUTH_PASSWORD: string;
		CODE_INTERPRETER_JUPYTER_AUTH_TOKEN: string;
		CODE_INTERPRETER_JUPYTER_TIMEOUT: number | string;
							...
							<div class=" self-center text-xs font-medium">{$i18n.t('Code Execution Engine')}</div>
								<div class="flex items-center relative">
									<select
										...
										required
									>
										<option disabled value="">{$i18n.t('Select a engine')}</option>
