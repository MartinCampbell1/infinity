<script lang="ts">
	...
	import type { ConnectionConfig, ConnectionForm } from '$lib/components/connection-types';
	...
	export let onSubmit: (connection: ConnectionForm) => void = () => {};
...
<AddConnectionModal
	...
	onSubmit={(connection: ConnectionForm) => {
		url = connection.url;
