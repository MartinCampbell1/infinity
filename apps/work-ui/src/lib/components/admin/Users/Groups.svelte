<script lang="ts">
	...
	type GroupSortKey = 'name' | 'members';
	type GroupSortItem = {
		value: GroupSortKey;
		label: string;
	};
	...
	let query = '';
	let sortBy: GroupSortKey = 'members';

	const sortItems: GroupSortItem[] = [
	...
	let defaultPermissions: GroupPermissions = mergeGroupPermissions();
