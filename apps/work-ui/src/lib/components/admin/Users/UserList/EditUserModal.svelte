<script lang="ts">
	...
	type UserUpdateForm = Pick<UserRecord, 'role' | 'profile_image_url' | 'email' | 'name'> & {
		password: string;
	};

	export let show = false;
	export let selectedUser: UserRecord = {
		id: '',
		profile_image_url: '',
		role: 'pending',
		name: '',
	...
	export let sessionUser: Pick<UserRecord, 'id'> = {
		id: ''
	};
