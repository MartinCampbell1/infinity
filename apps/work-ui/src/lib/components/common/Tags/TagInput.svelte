<script lang="ts">
	...
	export let suggestionTags = [] as SuggestionTag[];
	...
	const suggestionTagItems: SuggestionTag[] = suggestionTags;
</script>
...
{#if suggestionTagItems.length > 0}
	<datalist id="tagOptions">
		{#each suggestionTagItems as tag}
