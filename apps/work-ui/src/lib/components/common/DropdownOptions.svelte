<script lang="ts">
	...
	type DropdownOptionValue = string | null;
	type DropdownOption = {
	...
	export let value: DropdownOptionValue = '';
	...
	export let onChange: (value: DropdownOptionValue) => void = () => {};

	let selectComponent: Select | null = null;
	let open = false;
</script>
