<script lang="ts">
	...
	export let editHandler: MenuActionHandler;
	export let shareHandler: MenuActionHandler;
	export let cloneHandler: MenuActionHandler;
	export let exportHandler: MenuActionHandler;
	export let deleteHandler: MenuActionHandler;
	export let onClose: MenuActionHandler;
