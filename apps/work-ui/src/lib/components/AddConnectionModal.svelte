<script lang="ts">
	...
	export let onSubmit: (connection: ConnectionForm) => void | Promise<void> = () => {};
	...
	export let connection: ConnectionForm | null = null;

	let url = '';
	let key = '';
	let auth_type = 'bearer';

	let connectionType: 'external' | 'local' = 'external';
	let azure = false;
	$: azure =
	...
	const verifyOpenAIHandler = async () => {
		...
		let _headers: Record<string, unknown> | null = null;
