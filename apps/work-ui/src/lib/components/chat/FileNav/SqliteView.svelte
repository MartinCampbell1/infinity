<script lang="ts">
	...
	const init = async () => {
		try {
			// sql.js ships without bundled TypeScript declarations in this workspace.
			// Keep the import local and narrow the typed surface to this component.
			// @ts-ignore
