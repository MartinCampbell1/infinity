...
describe('normalizeHermesStreamEventName', () => {
	test('maps known stream aliases onto stable frontend events', () => {
		...
		expect(normalizeHermesStreamEventName('approval.requested')).toBe('approval');
		expect(normalizeHermesStreamEventName('approval.required')).toBe('approval');
		expect(normalizeHermesStreamEventName('needs_approval')).toBe('approval');
		expect(normalizeHermesStreamEventName('approval.resolved')).toBe('approval.resolved');
		expect(normalizeHermesStreamEventName('approval.approved')).toBe('approval.resolved');
		expect(normalizeHermesStreamEventName('approval.denied')).toBe('approval.resolved');
		expect(normalizeHermesStreamEventName('tool.finished')).toBe('tool');
		expect(normalizeHermesStreamEventName('tool.progress')).toBe('tool');
		expect(normalizeHermesStreamEventName('tool.result')).toBe('tool');
		...
		expect(normalizeHermesStreamEventName('session.compressed')).toBe('compressed');
		expect(normalizeHermesStreamEventName('session.warning')).toBe('warning');
