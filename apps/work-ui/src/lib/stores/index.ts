...
import type { HermesSessionListItem } from '$lib/utils/hermesSessions';
...
export const channels: Writable<ChannelState[]> = writable([]);
export const channelId = writable(null);

export const chats: Writable<ChatState[] | null> = writable(null);
export const pinnedChats: Writable<ChatState[]> = writable([]);
export const hermesSessionsByChatId: Writable<Record<string, HermesSessionListItem>> = writable({});
export const hermesRecentSessions: Writable<HermesSessionListItem[]> = writable([]);
export const tags = writable([]);
export const folders: Writable<FolderState[]> = writable([]);
...
type ToolServerState = Record<string, any>;

export const toolServers: Writable<ToolServerState[]> = writable([]);
export const terminalServers: Writable<ToolServerState[]> = writable([]);
