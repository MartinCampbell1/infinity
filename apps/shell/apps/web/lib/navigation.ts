...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: Workflow,
    children: [
      { key: "execution:hub", label: "Hub", href: "/execution", icon: FolderKanban },
      { key: "execution:runs", label: "Runs", href: "/execution/runs", icon: Workflow },
      { key: "execution:spec", label: "Spec", href: "/execution/spec", icon: FileText },
      { key: "execution:planner", label: "Planner", href: "/execution/planner", icon: GitBranch },
      { key: "execution:tasks", label: "Tasks", href: "/execution/tasks", icon: CheckSquare },
      { key: "execution:sessions", label: "Sessions", href: "/execution/sessions", icon: MessageSquare },
      { key: "execution:groups", label: "Groups", href: "/execution/groups", icon: Users },
      { key: "execution:accounts", label: "Accounts", href: "/execution/accounts", icon: WalletCards },
      { key: "execution:refusals", label: "Refusals", href: "/execution/refusals", icon: AlertTriangle },
      { key: "execution:recoveries", label: "Recoveries", href: "/execution/recoveries", icon: RotateCcw },
      { key: "execution:approvals", label: "Approvals", href: "/execution/approvals", icon: CheckSquare },
      { key: "execution:validation", label: "Validation", href: "/execution/validation", icon: ShieldCheck },
      { key: "execution:delivery", label: "Delivery", href: "/execution/deliveries", icon: ArrowRightLeft },
      { key: "execution:previews", label: "Previews", href: "/execution/previews", icon: PlayCircle },
      { key: "execution:review", label: "Review Lane", href: "/execution/review", icon: ShieldCheck },
